...
**Local STIX alternative:** This system has a local copy of the Enterprise ATT&CK dataset at `/home/leo/Desktop/cyber/enterprise-attack.json` (46MB STIX 2.1 bundle) with a query tool at `/home/leo/Desktop/cyber/attack.py`. See `references/local-stix-query.md` for full usage. Local queries are faster than TAXII and work offline — use them for quick lookups, platform/tactic filtering, and group intel.
...
- **[Local] Enterprise ATT&CK STIX bundle + query tool** — `references/local-stix-query.md`
